...
And that's about it! Not a very difficult problem but it can be tedious if done manually. Using the Google Maps api makes it easier for one to find the distance between locations and then arrange them accordingly. 